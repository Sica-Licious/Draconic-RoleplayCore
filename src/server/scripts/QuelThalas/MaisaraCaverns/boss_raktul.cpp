...
struct npc_malignant_soul : public ScriptedAI
{
    ...
    // Custom helper, NOT a virtual override - call this manually from wherever  
    // you detect the interrupt (e.g. a SpellScript::OnEffectHitTarget on the  
    // interrupting spell, or via SpellHit hook if it's a debuff/effect)  
    void HandleEternalSufferingInterrupted()
    {
